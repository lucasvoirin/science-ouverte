...
description: "Sur Debian, il est possible d'installer `R` à partir du gestionnaire de paquets `apt`. Toutefois, la version de `R` sur les dépôts Debian est généralement moins à jour que la version disponible sur le CRAN..."

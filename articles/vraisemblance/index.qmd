...
Aye ! La vraissemblance est toute petite : peine `{r} paste(round(likelihood*100, 1), "%")` de chance ! Cela signifie que si nous sommes sur Tatooine, ça serait très improbable d'avoir récolté un échantillon comme le notre !
...
barplot(likelihoods ~ c(1:11),
        names.arg = planets,
        xlab = "",
        ylab = "Vraisemblance de nos données",
        las = 2,
        )
```
